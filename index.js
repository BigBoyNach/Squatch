...
db.run(
  `CREATE TABLE IF NOT EXISTS userData(userId INTEGER, tag TEXT, username TEXT, ticketsOpenNow INTEGER, ticketsOpened INTEGER, messagesSent INTEGER)`
);
db.run(
  `CREATE TABLE IF NOT EXISTS ticketData(channelId INTEGER, channelName TEXT, ticketId INTEGER, authorId INTEGER, guildId INTEGER, ticketType TEXT, opened TEXT)`
);
db.run(
