...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option
        .setName("prize")
        .setDescription("Enter what the prize for the giveaway should be")
        .setRequired(true)
    )
    .addNumberOption((option) =>
      option
        .setName("winners")
        .setDescription("Enter the total amount of winners there should be")
        .setRequired(true)
    )
    .addStringOption((option) =>
      option
        .setName("endafter")
        .setDescription("Enterhow long the giveaway should last")
        .setRequired(true)
    )
    .addRoleOption((option) =>
      option
        .setName("role")
        .setDescription("Select a role you must have to enter the giveaway")
        .setRequired(true)
    ),
