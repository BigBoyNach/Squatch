...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('userid').setDescription('Please enter the ID of the user you would like to ban').setRequired(true))
    ...
    async execute(interaction, client) {
        ...
        interaction.guild.members.ban(userId).then((user) => {
